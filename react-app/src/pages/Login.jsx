      ...
      <div className="w-full max-w-md mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full relative">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-semibold text-gray-900 mb-2">ログイン</h1>
            <p className="text-gray-600 text-sm leading-6">アカウントにログインしてお買い物をお楽しみください</p>
          </div>
          ...
          <form className="mb-8" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center flex-wrap gap-4">
                ...
                <Link to="/forgot-password" className="text-blue-600 no-underline text-sm transition-colors hover:text-blue-800 hover:underline">
                  パスワードを忘れた方
                </Link>
              </div>
            </div>
            ...
            <div className="text-center my-8 relative">
              ...
              <span className="bg-white text-gray-500 px-4 text-sm relative">または</span>
            </div>
          ...
          <div className="text-center pt-8 border-t border-gray-200">
            <p className="text-gray-600 mb-2 text-sm">アカウントをお持ちでない方は</p>
            <Link to="/signup" className="text-blue-600 no-underline font-medium text-base transition-colors hover:text-blue-800 hover:underline">
              新規会員登録
            </Link>
          </div>
        </div>
